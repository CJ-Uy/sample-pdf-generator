...
const campus = "EVC 2024-2025";
const controlNumber = "000";
const schoolYear = "2024-2025";
const studentName = "Juan Dela Cruz";
const dateRequested = "09/13/2024";
const gradeSection = "8-Diamond";
const noOfStudents = "10";
const subject = "DMT";
const concurrentTopic = "3D Printing";
const unit = "Physics Unit";
const teacherInCharge = "Maam Cyril";
...
// } else {
//   venueOfExperiment = request.laboratoryReservations[0].laboratoryReserved.name;
...
//         ? dayjs(reservationDates.startDate[i]).format("MMM DD, YYYY")
//         : `${dayjs(reservationDates.startDate[i]).format(
//             "MMM DD, YYYY"
//           )} to ${dayjs(reservationDates.endDate[i]).format("MMM DD, YYYY")}`
//     );
//   }
// }
